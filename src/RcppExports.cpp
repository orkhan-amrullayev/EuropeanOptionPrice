...
RcppExport SEXP _EuropeanOptionPrice_europeanCallPriceWithBarrier(SEXP nIntSEXP, SEXP strikeSEXP, SEXP spotSEXP, SEXP barrierSEXP, SEXP volSEXP, SEXP rSEXP, SEXP expirySEXP, SEXP nRepsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_EuropeanOptionPrice_europeanCallPriceWithBarrier", (DL_FUNC) &_EuropeanOptionPrice_europeanCallPriceWithBarrier, 8},
    {NULL, NULL, 0}
};

RcppExport void R_init_EuropeanOptionPrice(DllInfo *dll) {
